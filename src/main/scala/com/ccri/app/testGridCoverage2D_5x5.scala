...
class testGridCoverage2D_5x5 {

}

object testGridCoverage2D_5x5 extends scala.App {
...
//Use transposed grid to construct it
    val arr = Array(300.0, 110.0, 100.0, 90.0, 80.0,
                    120.0, 200.0, 200.0, 90.0, 80.0,
                    120.0, 200.0, 100.0, 90.0, 80.0,
...
//                    160.0, 170.0, 180.0)
  ...
  val (xMin, yMin, xMax, yMax) = (38.073433, -78.494613, 38.078433, -78.489613) //x: Latitude, y: Longitude
  ...
  val gridSpec = DisplayGridSpec(5, 0.004)
